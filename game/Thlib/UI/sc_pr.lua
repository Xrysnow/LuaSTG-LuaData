...
stage.group.DefStageFunc('Spell Practice@Spell Practice','init',function(self)
	...
	task.New(self,function()
		...
		if _sc_table[lstg.var.sc_index][5] then
			_ref=New(_editor_class[_sc_table[lstg.var.sc_index][1]],{_editor_class[_sc_table[lstg.var.sc_index][1]].cards[_sc_table[lstg.var.sc_index][4]-1],_sc_table[lstg.var.sc_index][3]}) last=_ref
		else
			_ref=New(_editor_class[_sc_table[lstg.var.sc_index][1]],{boss.move.New(0,144,60,MOVE_DECEL),_sc_table[lstg.var.sc_index][3]}) last=_ref
		end
